...
const SLUG = "text-on-photo";
const seo = toolsSEO[SLUG];

export const Route = createFileRoute("/tools/text-on-photo")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "text-on-photo",
      description: seo?.description || "Free online text-on-photo tool",
...
function ToolPage() {
  return (
    <ToolLayout title="text-on-photo" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
