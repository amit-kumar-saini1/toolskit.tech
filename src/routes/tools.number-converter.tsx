...
const SLUG = "number-converter";
const seo = toolsSEO[SLUG];

export const Route = createFileRoute("/tools/number-converter")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "number-converter",
      description: seo?.description || "Free online number-converter tool",
...
function ToolPage() {
  return (
    <ToolLayout title="number-converter" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
