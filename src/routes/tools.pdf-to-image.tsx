...
export const Route = createFileRoute("/tools/pdf-to-image")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "pdf-to-image",
      description: seo?.description || "Free online pdf-to-image tool",
...
function ToolPage() {
  return (
    <ToolLayout title="pdf-to-image" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
