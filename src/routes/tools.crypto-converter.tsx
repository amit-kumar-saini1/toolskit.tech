...
const SLUG = "crypto-converter";
const seo = toolsSEO[SLUG];

export const Route = createFileRoute("/tools/crypto-converter")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "crypto-converter",
      description: seo?.description || "Free online crypto-converter tool",
...
function ToolPage() {
  return (
    <ToolLayout title="crypto-converter" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
