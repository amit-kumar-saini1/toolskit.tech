...
export const Route = createFileRoute("/tools/etsy-fee-calculator")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "etsy-fee-calculator",
      description: seo?.description || "Free online etsy-fee-calculator tool",
...
function ToolPage() {
  return (
    <ToolLayout title="etsy-fee-calculator" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
