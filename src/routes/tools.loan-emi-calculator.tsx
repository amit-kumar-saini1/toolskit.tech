...
export const Route = createFileRoute("/tools/loan-emi-calculator")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "loan-emi-calculator",
      description: seo?.description || "Free online loan-emi-calculator tool",
...
function ToolPage() {
  return (
    <ToolLayout title="loan-emi-calculator" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
