...
export const Route = createFileRoute("/tools/age-calculator")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "age-calculator",
      description: seo?.description || "Free online age-calculator tool",
...
function ToolPage() {
  return (
    <ToolLayout title="age-calculator" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
