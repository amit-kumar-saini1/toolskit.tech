...
export const Route = createFileRoute("/tools/remove-background")({
  head: () => ({
    meta: seoMeta({
      title: seo?.title || "remove-background",
      description: seo?.description || "Free online remove-background tool",
...
function ToolPage() {
  return (
    <ToolLayout title="remove-background" description="Coming soon" icon={Wrench} toolSlug={SLUG}>
